...
- Desktop: fixed left navigation rail with public routes and officer portal access
...
- Report wizard, public map, public detail, status tracking, and officer queue all inherit the same shell and action vocabulary
...
- `/officer`: dense operational review console
