...
vi.mock('@/pages/ux-v2/components/LocationReviewMapV2', () => ({
  LocationReviewMapV2: () => <div>Location map</div>,
}))

vi.mock('@/pages/ux-v2/components/NearbyReportPromptV2', () => ({
  NearbyReportPromptV2: () => null,
}))
...
vi.mock('@/pages/ux-v2/components/StaticReceiptMap', () => ({
  StaticReceiptMap: () => <div>Receipt map</div>,
}))

describe('ReportPageV2 mobile photo review', () => {
  beforeEach(() => {
