...
import { detectedLocationIcon, residentMarkerIcon, toLeafletPosition } from '@/lib/map'
import {
  isWithinServiceArea,
...
interface LocationReviewMapV2Props {
...
export function LocationReviewMapV2({
  location,
  detectedLocation,
  allowedRadiusMeters,
  selectionMode = 'marker',
  onLocationChange,
}: LocationReviewMapV2Props) {
  ...
  return (
    <div className="map-frame stack-md">
      {boundaryWarning ? (
        <div className="map-frame__banner map-frame__banner--warning" aria-live="polite">
      ...
      <div style={{ position: 'relative', flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        >
          ...
          {isFixedCenterMode ? (
            <CenterPinSelection location={location} onLocationChange={onLocationChange} />
          ) : (
            <ClickToPlacePin
              location={location}
          ...
          {detectedLocation ? (
            <Circle
              ...
              pathOptions={{ color: '#2f7dd3', fillColor: '#2f7dd3', fillOpacity: 0.12 }}
            />
          ) : null}
          ...
          {detectedLocation ? (
            <Marker
              ...
              zIndexOffset={400}
            >
              <Popup>Approximate device location. Use this as a guide only.</Popup>
            </Marker>
          ) : null}
          {!isFixedCenterMode ? (
            <Marker
